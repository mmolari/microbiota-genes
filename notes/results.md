...
*Data: [`isolate_gene_counts.csv`](../results/figs/isolate_gene_counts.csv).*
...
*Data: [`gene_enrichment.csv`](../results/figs/gene_enrichment.csv).*
...
*Data: [`st_pairwise_distance.csv`](../results/figs/st_pairwise_distance.csv).*
...
*Data: [`phylo_heatmap_pa_matrix.csv`](../results/figs/phylo_heatmap_pa_matrix.csv).*
