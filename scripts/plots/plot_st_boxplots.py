...
def parse_args():
    ...
    p.add_argument("--out-boxplot-base", required=True, help="Output path stem for the boxplot figure (no extension)")
    p.add_argument("--out-boxplot-with-counts-base", required=True, help="Output path stem for boxplot+counts figure (no extension)")
...
def main():
    ...
    plt.tight_layout()
    save_fig(fig, args.out_boxplot_base)
    print(f"Saved {args.out_boxplot_base}.(png|pdf)")
    ...
    plt.tight_layout()
    save_fig(fig2, args.out_boxplot_with_counts_base)
    print(f"Saved {args.out_boxplot_with_counts_base}.(png|pdf)")
